...
namespace task7_1
{
    class Hexahedron : Primitive
    {
        ...
        public Hexahedron(List<Point3D> p)
        {
            points = p;
            faces = new List<Face>();

            faces.Add(new Face(new List<Point3D> { points[0], points[1], points[5], points[3] }));
            faces.Add(new Face(new List<Point3D> { points[2], points[6], points[3], points[0] }));
            faces.Add(new Face(new List<Point3D> { points[4], points[1], points[0], points[2] }));
            faces.Add(new Face(new List<Point3D> { points[7], points[5], points[3], points[6] }));
            faces.Add(new Face(new List<Point3D> { points[2], points[4], points[7], points[6] }));
            faces.Add(new Face(new List<Point3D> { points[4], points[1], points[5], points[7] }));
        }
