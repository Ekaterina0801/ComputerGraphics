...
namespace task7_1
{
    class Octahedron : Primitive
    {
        ...
        public Octahedron(List<Point3D> p)
        {
            points = p;
            faces = new List<Face>();

            faces.Add(new Face(new List<Point3D> { points[0], points[2], points[4] }));
            faces.Add(new Face(new List<Point3D> { points[2], points[4], points[3] }));
            faces.Add(new Face(new List<Point3D> { points[4], points[5], points[3] }));
            faces.Add(new Face(new List<Point3D> { points[0], points[5], points[4] }));
            faces.Add(new Face(new List<Point3D> { points[0], points[5], points[1] }));
            faces.Add(new Face(new List<Point3D> { points[5], points[3], points[1] }));
            faces.Add(new Face(new List<Point3D> { points[0], points[2], points[1] }));
            faces.Add(new Face(new List<Point3D> { points[2], points[1], points[3] }));
        }
