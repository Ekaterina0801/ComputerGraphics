...
namespace lab3
{
    public partial class _1b : Form
    {
        ...
        //поиск границ
        private void findBorders(Point our_p, ref Point leftBound, ref Point right_b, Bitmap b, Color c)
        {
        ...
        private void Fill(Point p, Color c)
        {
            ...
            if (0 < p.X && p.X < b.Width && 0 < p.Y && p.Y < b.Height)
            {
                ...
                Point leftBound = p, right_b = p;
                findBorders(p, ref leftBound, ref right_b, b, c); //поиск границ
                if (leftBound.X < left)
                    left = leftBound.X;
                if (right_b.X > right)
                    right = right_b.X;
                ...
                l.Add(Tuple.Create(leftBound, right_b));
                for (int i = leftBound.X + 1; i < right_b.X; ++i)
        ...
        private void pictureBox_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                Fill(start, pictureBox.BackColor);
